...
class Lane:
    ...
    def update_speed(self, end_pts, speed_up_dist, slow_down_dist, vlow, end=False, it=None):
        vnew = [-1] * self.size
        if it != None:
    ...
    def update_position(self, start=False, start_pts=0, end=False, end_pts=0, it = None):
